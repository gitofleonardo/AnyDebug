...
class Holder(view: View) : RecyclerView.ViewHolder(view) {
    fun bindItem(item: ViewRule) {
        ...
        binding.apply {
            ...
            viewIdText.text = SpannableString(moduleRes.getString(R.string.view_id_text, item.viewId.toString()))
            parentIdText.text = SpannableString(moduleRes.getString(R.string.view_parent_id_text, item.viewParentId.toString()))
            viewRuleTypeText.text = SpannableString(moduleRes.getString(R.string.view_rule_type, item.ruleType.toString()))
            ruleContentText.text = SpannableString(moduleRes.getString(R.string.view_rule_content, item.viewRule))
        }
    }
}